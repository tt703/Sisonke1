...
public class EstimatePreviewActivity extends AppCompatActivity {
    ...
    private EstimatePreviewBinding binding;
    ...
    private void saveEstimateDetails(File pdfFile) {
        ...
        try (DatabaseHelper dbHelper = new DatabaseHelper(this)) {
            ...
            if (isInserted) {
                ...
                Log.d(TAG, "saveEstimateDetails: failed to save estimate");
            }
        } catch (Exception e) {
    ...
    private void retrieveIntentData() {
        ...
        if (extras != null) {
            ...
            String actionType = extras.getString("actionType", "Create Estimate");
    ...
    private File createEstimatePDF() {
        ...
        try {
            ...
            //Title
            Paragraph title = new Paragraph("ESTIMATE", headerFont);
            title.setAlignment(Element.ALIGN_CENTER);
            document.add(title);

            Paragraph estimateNote = new Paragraph("This is an estimate and not a final invoice. Prices are subject to change.", subHeaderFont);
            estimateNote.setAlignment(Element.ALIGN_CENTER);
    ...
    private String getCurrentDate() {
        ...
        Log.d("EstimateGenerator", "Current Date: " + currentDate);
        return currentDate;
    }
